...
git pull --ff-only
sudo docker run --rm --network=24hc24 -v /var/www/odysseehaumere.haum.org/:/persist haum/24hc24-django sh -c 'python3 /persist/24hc24/server24hc/manage.py migrate'
